...
class ContractTester:
    def __init__(self, miner="miner1", contract_file="contracts/contract-counter.clar"):
        self.miner = miner
...
def main():
    ...
    parser.add_argument("--contract", default="contracts/contract-counter.clar", 
                       help="Contract file to deploy (default: contracts/contract-counter.clar)")
