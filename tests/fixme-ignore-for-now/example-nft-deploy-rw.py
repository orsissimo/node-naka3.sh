...
def main():
    ...
    try:
        ...
        tx_hex = cli.publish_contract(
            ...
            "cyberpunk2140a",
            os.path.join(
                os.path.dirname(__file__), "..", "contracts/cyberpunk2140a.clar"
            ),
        )
        ...
        max_tokens = api.call_read_only_function(
            account.address, "cyberpunk2140a", "get-last-token-id", account.address, []
        )
        ...
        mint_price = api.call_read_only_function(
            account.address, "cyberpunk2140a", "get-mint-price", account.address, []
        )
        logger.success("Read-only call successful")
        ...
        available_count = api.call_read_only_function(
            account.address,
            "cyberpunk2140a",
            "get-available-count",
            account.address,
        ...
        initial_minted = api.call_read_only_function(
            account.address, "cyberpunk2140a", "get-minted-count", account.address, []
        )
        logger.success("Read-only call successful")
        ...
        collection_attr = api.call_read_only_function(
            account.address,
            "cyberpunk2140a",
        ...
        data_frozen = api.call_read_only_function(
            account.address,
            "cyberpunk2140a",
            "is-collection-data-frozen",
            account.address,
            [],
        )
        logger.success("Read-only call successful")
        ...
        final_minted = api.call_read_only_function(
            account.address, "cyberpunk2140a", "get-minted-count", account.address, []
        )
        logger.success("Read-only call successful")
        ...
        final_collection_attr = api.call_read_only_function(
            account.address,
            "cyberpunk2140a",
            "get-collection-attribute",
            account.address,
