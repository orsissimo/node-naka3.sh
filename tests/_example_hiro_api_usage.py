...
def test_and_capture_responses():
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_status"] = {
            ...
            "method": "GET",
            "success": True,
            "response": status.model_dump() if hasattr(status, 'model_dump') else status.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_transaction_list"] = {
            ...
            "parameters": {"limit": 5},
            "success": True,
            "response": txs.model_dump() if hasattr(txs, 'model_dump') else txs.__dict__
        }
    ...
    if txs and txs.results:
        ...
        try:
            ...
            output_data["endpoints_tested"]["get_transaction_by_id"] = {
                ...
                "success": True,
                "response": tx.model_dump() if hasattr(tx, 'model_dump') else tx.__dict__
            }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_contract_by_id"] = {
            ...
            "success": True,
            "response": contract.model_dump() if hasattr(contract, 'model_dump') else contract.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_contract_events_by_id"] = {
            ...
            "parameters": {"contract_id": contract_id},
            "success": True,
            "response": events.model_dump() if hasattr(events, 'model_dump') else events.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_account_assets"] = {
            ...
            "success": True,
            "response": assets.model_dump() if hasattr(assets, 'model_dump') else assets.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_account_inbound"] = {
            ...
            "parameters": {"principal": test_address, "limit": 3},
            "success": True,
            "response": inbound.model_dump() if hasattr(inbound, 'model_dump') else inbound.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_address_mempool_transactions"] = {
            ...
            "parameters": {"principal": test_address, "limit": 3},
            "success": True,
            "response": mempool.model_dump() if hasattr(mempool, 'model_dump') else mempool.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["get_account_nonces"] = {
            ...
            "success": True,
            "response": nonces.model_dump() if hasattr(nonces, 'model_dump') else nonces.__dict__
        }
    ...
    try:
        ...
        output_data["endpoints_tested"]["search_by_id"] = {
            ...
            "success": True,
            "response": search.model_dump() if hasattr(search, 'model_dump') else search.__dict__
        }
    ...
    successful_tests = sum(1 for test in output_data["endpoints_tested"].values() if test.get("success", False))
    ...
    logger.info(f"Summary: {successful_tests}/{total_tests} tests passed ({output_data['summary']['success_rate']})")
